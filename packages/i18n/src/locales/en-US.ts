...
export const enUS = {
  ...
  viewport: {
    ...
    camera: 'Camera',
    empty: 'Empty world — describe the building you want',
    angles: {
  ...
  chat: {
    ...
    truncated:
      '[TRUNCATED] This turn hit the output token limit ({{out}} out) with an empty body and no tool call — thinking used up the whole budget. Be more specific and try again.',
  ...
  settings: {
    ...
    pricingNone: 'No prices yet — the meter will show token counts only, no dollar amount.',
    pricingHint: 'USD per million tokens. The model id must match the model field exactly.',
    ...
    llm: {
      ...
      notChosen: 'Could not reach the endpoint to pick a model — the URL or API key is probably wrong. Run architect providers for the details',
      keyNote:
        'The API key is kept on this computer only and is never written into a project file (project files are meant to be shared).',
  ...
  image: {
    ...
    notAnImage: 'Not a recognisable image format (extension {{ext}}; PNG / JPEG / WebP / GIF only)',
  },
  recovery: {
  ...
  desktop: {
    ...
    edit: {
      outsideBreak: 'That cell is outside the world height — nothing to break',
      alreadyAir: 'That cell is already empty',
      noBlockSelected: 'No block selected yet',
      unknownBlock: 'Unknown block: {{name}}',
      outsidePlace: 'That cell is outside the world height — cannot place there',
    },
    export: {
    ...
    chatBlocking: {
      ...
      needModel: 'No model selected yet — open Settings and click Apply; the app will pick one',

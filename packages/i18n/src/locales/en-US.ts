...
export const enUS = {
  ...
  chat: {
    ...
    attachImageTip: 'Pick image files to send to the model along with this message',
    grabViewport: 'Capture viewport',
    grabViewportTip: 'Turn what you are looking at right now into an image and send it with this message',
